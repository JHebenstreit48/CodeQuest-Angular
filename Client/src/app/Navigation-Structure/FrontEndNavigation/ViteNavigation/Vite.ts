    ...
    },
    {
      ...
      subpages: [
        ...
        { name: 'Plugins', path: '/vite/corefeatures/plugins' }, // How to use and create plugins
        {
          ...
          path: '/vite/corefeatures/envvariables',
        }, // Using .env files
      ],
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'Optimizing Dependencies',
          path: '/vite/advanced/optimization',
      ...
      subpages: [
        {
          ...
          path: '/vite/bestpractices/performance',
        }, // Tips for faster builds and runtime
