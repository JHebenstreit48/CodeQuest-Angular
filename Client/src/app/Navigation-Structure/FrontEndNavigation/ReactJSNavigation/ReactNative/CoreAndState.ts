      ...
      subpages: [
        ...
        },
        {
          ...
          subpages: [
            ...
            {
              name: 'Using Context API Effectively',
              path: '/react/native/statemanagement/advanced/context',
            },
          ],
        },
        {
          ...
          subpages: [
            ...
            {
              name: 'Avoiding Common State Issues',
              path: '/react/native/statemanagement/best-practices/common-issues',
            },
          ],
        },
      ],
