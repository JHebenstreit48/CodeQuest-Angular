          ...
          subpages: [
            {
              ...
              path: '/react/native/building/advanced/cicd',
            },
            {
              name: 'Handling Environment Variables',
              path: '/react/native/building/advanced/env-variables',
            },
          ],
        },
        {
          ...
          subpages: [
            {
              ...
              path: '/react/native/building/best-practices/optimization',
            },
            {
              name: 'Deployment Strategies',
              path: '/react/native/building/best-practices/deployment',
            },
          ],
        },
      ],
        ...
        },
        {
          ...
          subpages: [
            ...
            },
            {
              ...
              path: '/react/native/performance/advanced/memory',
            },
          ],
        },
        {
          ...
          subpages: [
            ...
            {
              name: 'Avoiding Performance Pitfalls',
              path: '/react/native/performance/best-practices/pitfalls',
            },
          ],
        },
      ],
