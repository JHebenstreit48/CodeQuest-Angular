      ...
      subpages: [
        {
          ...
          path: '/tools/cicd/circleci/intro',
        },
        {
          name: 'Installing & Setting Up CircleCI',
          path: '/tools/cicd/circleci/setup',
        },
        {
          name: 'Understanding CircleCI Workflows',
          path: '/tools/cicd/circleci/workflows',
        },
        {
          name: 'Configuring a `.circleci/config.yml` File',
          path: '/tools/cicd/circleci/config',
        },
      ],
    },
      ...
      subpages: [
        {
          ...
          path: '/tools/cicd/circleci/pipelines',
        },
        {
          name: 'Running Tests in CircleCI',
          path: '/tools/cicd/circleci/testing',
        },
        {
          name: 'Building & Deploying Applications',
          path: '/tools/cicd/circleci/deployment',
        },
        {
          name: 'Optimizing CI/CD Workflows',
          path: '/tools/cicd/circleci/optimization',
        },
      ],
    },
      ...
      subpages: [
        {
          ...
          path: '/tools/cicd/circleci/orbs',
        },
        {
          name: 'Caching & Performance Tuning',
          path: '/tools/cicd/circleci/caching',
        },
        {
          name: 'Parallelism & Test Splitting',
          path: '/tools/cicd/circleci/parallelism',
        },
        {
          name: 'Security & Compliance in CircleCI',
          path: '/tools/cicd/circleci/security',
        },
      ],
    },
