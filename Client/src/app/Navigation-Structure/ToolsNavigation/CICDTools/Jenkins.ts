...
const JenkinsNavigation: Subpage = {
  ...
  subpages: [
    // ---------- Jenkins Fundamentals Navigation Start ----------
    {
      ...
      subpages: [
        { name: 'Introduction to Jenkins', path: '/tools/cicd/jenkins/intro' },
        {
          ...
          path: '/tools/cicd/jenkins/setup',
        },
        {
          name: 'Understanding Jenkins Pipelines',
          path: '/tools/cicd/jenkins/pipelines',
        },
        {
          name: 'Jenkinsfile Configuration',
          path: '/tools/cicd/jenkins/jenkinsfile',
        },
      ],
    },
      ...
      subpages: [
        {
          ...
          path: '/tools/cicd/jenkins/create-pipelines',
        },
        {
          name: 'Running Tests in Jenkins',
          path: '/tools/cicd/jenkins/testing',
        },
        {
          name: 'Deploying Applications with Jenkins',
          path: '/tools/cicd/jenkins/deployment',
        },
        {
          name: 'Automating Builds & Releases',
          path: '/tools/cicd/jenkins/automation',
        },
      ],
    },
    ...
    // ---------- Advanced Jenkins Features Navigation Start ----------
    {
      ...
      subpages: [
        {
          name: 'Using Plugins in Jenkins',
          path: '/tools/cicd/jenkins/plugins',
        },
        {
          name: 'Jenkins Distributed Builds',
          path: '/tools/cicd/jenkins/distributed-builds',
        },
        {
          name: 'Security & Authentication',
          path: '/tools/cicd/jenkins/security',
        },
        {
          name: 'Performance Optimization',
          path: '/tools/cicd/jenkins/performance',
        },
      ],
    },
