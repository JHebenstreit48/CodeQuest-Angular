  ...
  subpages: [
    {
      ...
      subpages: [
        { name: 'What is Authorization?', path: '/authz/basics/whatis' },
        {
          ...
          path: '/authz/basics/rbac',
        },
        {
          name: 'Permission-Based Access Control (PBAC)',
          path: '/authz/basics/permissions',
        },
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'Authorization in Microservices',
          path: '/authz/advanced/microservices',
        },
        { name: 'SSO & Federated Identity', path: '/authz/advanced/sso' },
        {
          name: 'Custom Auth Providers',
          path: '/authz/advanced/custom-providers',
        },
        {
          name: 'Scaling Authorization Systems',
          path: '/authz/advanced/scaling-authz',
        },
        {
          name: 'Auditing & Logging for Access Control',
          path: '/authz/advanced/logging',
        },
      ],
    },
  ],
