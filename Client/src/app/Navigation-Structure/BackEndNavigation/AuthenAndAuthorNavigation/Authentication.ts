  ...
  subpages: [
    {
      ...
      subpages: [
        ...
        {
          name: 'Session vs Token Authentication',
          path: '/auth/basics/session-vs-token',
        },
        {
          name: 'Stateful vs Stateless Auth',
          path: '/auth/basics/stateful-vs-stateless',
        },
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'Session-Based Auth (Cookies)',
          path: '/auth/methods/sessions',
        },
        { name: 'JWT & Token-Based Auth', path: '/auth/methods/jwt' },
        { name: 'OAuth & OpenID Connect', path: '/auth/methods/oauth-oidc' },
        {
          name: 'Social Logins (Google, GitHub)',
          path: '/auth/methods/social-logins',
        },
        { name: 'API Key Authentication', path: '/auth/methods/api-keys' },
        {
          name: 'WebAuthn (Passkeys & Biometrics)',
          path: '/auth/methods/webauthn',
        },
      ],
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'OAuth with React & Next.js',
          path: '/auth/oauth/react-nextjs',
        },
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'Auth in Express & Node.js',
          path: '/auth/frameworks/node-express',
        },
        {
          name: 'Auth in Next.js & React',
          path: '/auth/frameworks/nextjs-react',
        },
        {
          name: 'Auth in Django & Flask',
          path: '/auth/frameworks/django-flask',
        },
      ...
      subpages: [
        {
          ...
          path: '/auth/security/bruteforce',
        },
        {
          name: 'Session Hijacking & CSRF',
          path: '/auth/security/hijacking-csrf',
        },
        {
          name: 'Credential Stuffing Protection',
          path: '/auth/security/credentialstuffing',
        },
        {
          name: 'Secure Passwordless Auth',
          path: '/auth/security/passwordless',
        },
        {
          name: 'Zero Trust & Access Control',
          path: '/auth/security/zerotrust',
        },
      ],
    },
  ],
