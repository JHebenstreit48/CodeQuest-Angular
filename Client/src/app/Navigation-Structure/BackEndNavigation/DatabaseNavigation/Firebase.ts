  ...
  subpages: [
    {
      ...
      subpages: [
        ...
        {
          name: 'Firebase vs Traditional Databases',
        ...
        {
          name: 'Setting Up a Firebase Project',
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'Firebase Auth Overview',
          path: '/databases/firebase/auth/overview',
        },
        {
          name: 'Using Firebase Authentication',
          path: '/databases/firebase/auth/implementation',
        },
        {
          name: 'OAuth & Social Logins',
          path: '/databases/firebase/auth/social-logins',
        },
        {
          name: 'Managing Users & Permissions',
          path: '/databases/firebase/auth/user-management',
        },
      ],
    },
    {
      ...
      subpages: [
        {
          name: 'Introduction to Realtime Database',
          path: '/databases/firebase/realtime/overview',
        },
        {
          name: 'Database Structure & Rules',
        ...
        {
          name: 'Realtime Listeners & Syncing',
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'What is Firestore?',
          path: '/databases/firebase/firestore/overview',
        },
        {
          name: 'Firestore vs Realtime Database',
    ...
    },
    {
      ...
      subpages: [
        {
          name: 'Introduction to Firebase Storage',
