  ...
  subpages: [
    {
      ...
      subpages: [
        ...
        {
          name: 'Installing & Setting Up MongoDB',
          path: '/databases/mongodb/intro/setup',
        },
        {
          name: 'MongoDB Use Cases',
    ...
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'Bulk Operations & Transactions',
    ...
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'Index Performance Optimization',
    ...
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'Common Aggregation Operators',
          path: '/databases/mongodb/aggregation/operators',
        },
        {
          name: 'Performance Optimization in Aggregation',
    ...
    },
    {
      ...
      subpages: [
        ...
        {
          name: 'Best Practices for Scaling MongoDB',
