      ...
      subpages: [
          ...
          subpages: [
            {
              ...
              path: '/ruby/fundamentals/variables',
            },
            {
              name: 'Control Flow & Loops',
              path: '/ruby/fundamentals/control-flow',
            },
        ...
        },
        {
          ...
          subpages: [
            ...
            {
              name: 'Metaprogramming in Ruby',
              path: '/ruby/advanced/metaprogramming',
            },
            { name: 'Error Handling', path: '/ruby/advanced/error-handling' },
            {
              name: 'Concurrency & Multithreading',
              path: '/ruby/advanced/concurrency',
            },
          ],
        },
      ],
        ...
        { name: 'Introduction to Rails', path: '/ruby/rails/intro' },
        {
          ...
          subpages: [
            { name: 'MVC Architecture', path: '/ruby/rails/fundamentals/mvc' },
            {
              ...
              path: '/ruby/rails/fundamentals/routing',
            },
            {
              name: 'Active Record & ORM',
              path: '/ruby/rails/fundamentals/active-record',
            },
            {
              name: 'Rails Controllers',
              path: '/ruby/rails/fundamentals/controllers',
            },
            {
              name: 'Views & ERB Templates',
              path: '/ruby/rails/fundamentals/views',
            },
          ],
        },
        {
          ...
          subpages: [
            {
              name: 'Middleware in Rails',
              path: '/ruby/rails/advanced/middleware',
            },
            {
              name: 'Background Jobs & Sidekiq',
              path: '/ruby/rails/advanced/background-jobs',
            },
            {
              name: 'Security in Rails',
              path: '/ruby/rails/advanced/security',
            },
            {
              name: 'Performance Optimization',
              path: '/ruby/rails/advanced/performance',
            },
          ],
        },
      ],
